 ...
 * @author Janusz
 */
public class MoveForwardButton extends JButton{
    ...
    public synchronized void paint(Graphics g){
        ...
        int[] x1 = { 10, 10          , width/2 };
        int[] y1 = { 10, height - 10 , height/2 };
        
        int[] x2 = { width/2, width/2          , width - 10 };
        int[] y2 = { 10, height - 10 , height/2 };
